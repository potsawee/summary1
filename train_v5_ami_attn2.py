...
"""
qsub -cwd -j yes -P esol -l qp=low -o LOGs/run-array.txt -t 1-20 submit/run-array-job.sh
/home/alta/summary/pm574/summariser1/temp/decode_list.txt
/home/alta/summary/pm574/summariser1/submit/train_v5_ami_attn2.sh SET
"""
