...
from models.hierarchical_rnn_v5 import EncoderDecoder
...
decoding_method = 'teacherfv2'
attn_score_path = "/home/alta/summary/pm574/summariser1/lib/attn_scores_u/HGRUV5_CNNDM/{}/".format(decoding_method)
...
def train_v5(start_idx, end_idx):
    ...
    with torch.no_grad():
        numbers = [x for x in range(start_idx, end_idx)]
        ...
        # for bn in range(start_idx, end_idx):
            ...
            if decoding_method == 'teacherfv2':
                ...
                # output = output[1:].unsqueeze(0).cpu().numpy().tolist()[0]
            ...
            # print("div1:", mean_div_within_sentence)
            # print("div2:", mean_div_between_sentences)
