...
from train_v5 import diverisity_loss

# --------------------------------------------------------- #
REPO = '/home/alta/summary/pm574/podcast_sum0/'
...
def train_v5_cnndm():
    ...
    if args['use_gpu']:
        if 'X_SGE_CUDA_DEVICE' in os.environ: # to run on CUED stack machine
            ...
            os.environ["CUDA_VISIBLE_DEVICES"] = '0,1,2,3' # choose the device (GPU) here
        device = 'cuda'
    else:
        device = 'cpu'
...
def adjust_lr(optimizer, step, warmup=5000):
